...
{
    public class CreateBudgetRecordRequestValidatorTests
    {
        private readonly CreateBudgetRecordRequestValidator _validator;
        private readonly Faker _faker;

        public CreateBudgetRecordRequestValidatorTests()
        {
            _validator = new CreateBudgetRecordRequestValidator();
            _faker = new Faker();
        }
